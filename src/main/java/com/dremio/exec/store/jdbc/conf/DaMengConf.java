 ...
 */
@SourceType(value = "DAMENG", label = "DaMeng")
public class DaMengConf extends AbstractArpConf<DaMengConf> {

    private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(DaMengConf.class);

    private static final String ARP_FILENAME = "arp/implementation/dameng-arp.yaml";
