...
## DaMeng example
The DaMeng example provided here shows and example ARP YAML file for SQLite and the associated files require to build a connector
from the template. 
...
3. Take the DaMeng JDBC driver from (dmdbms/drivers/jdbc) and put in in the \dremio\jars\3rdparty folder
4. Restart Dremio
